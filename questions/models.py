...
class Question(models.Model):
    ...
    answer = models.CharField(
        max_length=500, help_text='Enter the answer that returns the correct result i.e a number ')
...
class ProgrammingQuestion(models.Model):
    ...
    answer = models.CharField(
        max_length=500, help_text='Enter the python program that returns the correct result ')
    category = models.ManyToManyField(
        Category, help_text='Select a category for this question')
